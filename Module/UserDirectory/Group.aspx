<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Group.aspx.cs" Inherits="Module.UserDirectory.Group" %>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 ">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <div class="mr-4 ml-3">
                                        <a id="editUrl"><input runat="server" class="btn btn-light" type="image" src="~/Content/img/edit.svg" data-toggle="tooltip" data-placement="top" title="Edit" /></a>
                                        <%--<input runat="server" class="btn btn-light" type="image" src="~/Content/img/rotate.svg"  data-toggle="tooltip" data-placement="top" title="Reset" />--%>
                                    </div>
                                    <div class="mr-4">                                        
                                        <a id="newUrl"><input runat="server" class="btn btn-light" type="image" src="~/Content/img/Add.svg" data-toggle="tooltip" data-placement="top" title="New Stakeholder" /></a>
                                    </div>                                   
                                    <div class="mr-4">                                        
                                        <input runat="server" class="btn btn-delete btn-light" type="image" src="~/Content/img/trashcan.svg" data-toggle="tooltip" data-placement="top" title="Delete" />
                                    </div>
                                </div>
                            </div>
                        </div><!-- Col -->
         ...
         serviceAPI: '<%=ConfigurationManager.AppSettings["ApiPath"]%>',              
          ...
          $(document).ready(function () {
              ...
              $("#CardRow").on("click", ".CardDet", function () {
                  ...
                  //document.getElementsByClassName("link").setAttribute("href", "ViewDetail.aspx?Id=" + Id);

                  //StakeholderList.getMember('stake/GetMemberStakeholder', Id);             
