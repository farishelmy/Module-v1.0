<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="NewStakeholder.aspx.cs" Inherits="Module.UserDirectory.NewStakeholder" %>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 form-group">
                                                ...
                                                <input id="first_name" name="first_name" type="text" class="form-control" placeholder="Smith...">
                                            </div>
                                            <div class="col-sm-4 form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
             ...
             $("#simpleform").submit(function (e) {  
                ...
                var apiurl = "<%=ConfigurationManager.AppSettings["ApiPath"]%>"+"stake/PutAddStakeholder";  
                var author =
                    {
