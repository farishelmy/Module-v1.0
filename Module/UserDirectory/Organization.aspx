<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Organization.aspx.cs" Inherits="Module.UserDirectory.Organization" %>
      ...
      <script type="text/javascript">     
         ...
         serviceAPI: '<%=ConfigurationManager.AppSettings["ApiPath"]%>',              
          ...
          $(document).ready(function () {
              ...
              var Link = "NewStakeholder.aspx";              
              document.getElementById("newUrl").setAttribute("href", Link); 
