<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Module.KnowledgeWorker.Dashboard" %>
        ...
        <section class="dashboard-counts section-padding">
              ...
              <div class="row">
                ...
                <div class="col-xl-2 col-md-4 col-6">
                  <div class="wrapper count-title d-flex">
                    ...
                    <div class="name"><strong class="text-uppercase">Lab</strong><span><dx:ASPxLabel ID="DateLab" runat="server" Text=""></dx:ASPxLabel>
                    </span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Factory</strong><span><dx:ASPxLabel ID="DateFac" runat="server" Text=""/></span>
                  <div class="count-number">
                      <dx:ASPxLabel ID="lblTotalFac" runat="server" Text=""></dx:ASPxLabel>
                  </div>
                </div>
              </div>
            </div> 
