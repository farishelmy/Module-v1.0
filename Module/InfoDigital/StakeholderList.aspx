<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="StakeholderList.aspx.cs" Inherits="Module.InfoDigital.StakeholderList" %>
         ...
         <div >
             <form class="form-inline">
                ...
                <a href="#"><input runat="server" type="image" src="../Content/img/backward.svg" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="Reset"></a>
                   &nbsp;
                   &nbsp;
              <%--  <a href="/InfoDigital/NewStakeholder.aspx"><input type="image" src="../Content/img/medical.svg" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="New"></a>  
                   &nbsp;
                   &nbsp;
